...
/**
 * Entité représentant le socle/corps d'une ruche
 */
public class BeehiveBase implements Serializable {
    ...
    private List<Frame> frames; // Max 10 cadres, min 1
    ...
    public void removeFrame(Frame frame) {
        if (this.frames != null && this.frames.size() > 1) { // Minimum 1 cadre
